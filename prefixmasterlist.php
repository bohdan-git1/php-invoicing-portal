...
<td> <a href="<?php echo 'editprefix.php?action=edit&id='.$row->id;?>"> Edit </a> </td>

<td style="text-align:center"> 

 
 &nbsp; &nbsp; <image src="remove.png" width="20" height="20" title="Delete" onclick="checkdelte(<?php echo $row->id;?>)"/> </td>
</tr>
