...
<td>
<input type="text" name="descrfromDates[]" value="" class="fromdatecal"  />  to <input type="text" name="descrtoDates[]" value="" class="todatecal"  />
</td>
...
<p>This invoice is for the period of <input type="text" id="from_date" name="fromDate" value="" class="fromdatecal"  />  to <input type="text"  id="to_date" name="toDate" value="" class="todatecal"  />. </p>
...
<p><input type="text" class="form-control" name="paymentscanbedone" value="Payments can be done through Paypal,Skrill,Western union,Wire transfer,Payoneer,Local bank deposit" /> </p>
...
if (isset($_POST['conform'])){
	...
	$totalchargedamount = mysqli_escape_string($_SERVER['con'],$_POST['totalchargedamount']);
	$invoicebilleddesc = mysqli_escape_string($_SERVER['con'],$_POST['invoicebilleddesc']);
    	$invoiceoutstanding =mysqli_escape_string($_SERVER['con'], $_POST['outstanding']);
	...
	$invoicedisputeemail = mysqli_escape_string($_SERVER['con'],$_POST['invoicedisputeemail']);
		
	$ftotamount = round($totalchargedamount,0);
	$pdffilename = trim($companyname.'-'.date("d-M-y").'-'.$ftotamount.'.pdf');
	
	  $sqlinv = "INSERT INTO   ws_goodservice_clientinvoice_master (`company_id`, `companyname`, `invoicenumber`, `invoicecreateddate`, `invoiceduedate`,  `invoiceamount`, `invoiceoutstanding`, `invoicesubtotal`, `invoicefromdate`, `invoicetodate`, `paidamount`, `pdffilename`,invoicebilleddesc,invoicedisputeemail,invoiceLocalBank,paymentscanbedone) 
